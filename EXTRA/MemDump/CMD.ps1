...
Function HelpMessage
{
    ...
    Write-Output "Usage: .\CMD.ps1 [-Tool] [--Pagefile]"
    Write-Output ""
    Write-Output "Tools:"
    ...
    Write-Output ".\CMD.ps1 -Comae"
    Write-Output ".\CMD.ps1 -DumpIt"
    Write-Output ".\CMD.ps1 -WinPMEM"
    Write-Output ".\CMD.ps1 -RamCapture"
    Write-Output ".\CMD.ps1 -Belkasoft"
    Write-Output ".\CMD.ps1 -DumpIt --Pagefile"
    Write-Output ".\CMD.ps1 -WinPMEM --Pagefile"
    Write-Output ""
    Exit
}
