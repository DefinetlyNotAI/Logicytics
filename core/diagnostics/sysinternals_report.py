...
class SysinternalsReportCollector(CoreCollector):
    ...
    def metadata(cls) -> CollectorMetadata:
        ...
        return CollectorMetadata(
            id="core.diagnostics.sysinternals_report", name="Sysinternals report", version="4.0.0", specialty=Specialty.DIAGNOSTICS,
            description="Reports supported Sysinternals binary/archive state and consolidates available tool output.", author="Logicytics",
            supported_platforms=("win32",), capabilities=(Capability.SUBPROCESS,), sensitive_data_categories=("system_diagnostics",),
    ...
    def collect(self, context: CollectorContext) -> CollectorResult:
        ...
        search_roots = (project_root / "sysinternals", project_root / "tools" / "sysinternals", Path(os.environ.get("ProgramFiles", r"C:\Program Files")) / "Sysinternals")
