    ...
    def collect(self, context: CollectorContext) -> CollectorResult:
        ...
        if completed.returncode != 0:
            ...
            if _is_access_denied(detail):
                return CollectorResult(CollectorStatus.SKIPPED, "system-diagnostics access was denied for the current account", errors=(detail,))
        ...
        try:
            ...
            return CollectorResult(CollectorStatus.FAILED, "system-diagnostics query returned invalid JSON", errors=(str(error),))
