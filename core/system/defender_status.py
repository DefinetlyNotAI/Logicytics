    ...
    def collect(self, context: CollectorContext) -> CollectorResult:
        ...
        if completed.returncode != 0:
            ...
            if _is_unavailable(detail):
                return CollectorResult(CollectorStatus.SKIPPED, "Microsoft Defender status is unavailable", errors=(detail,))
        ...
        try:
            ...
            return CollectorResult(CollectorStatus.FAILED, "Defender status query returned invalid JSON", errors=(str(error),))
