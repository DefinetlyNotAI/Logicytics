    ...
    def collect(self, context: CollectorContext) -> CollectorResult:
        ...
        if completed.returncode != 0:
            ...
            if _is_access_denied(detail):
                return CollectorResult(CollectorStatus.SKIPPED, "network-interface access was denied for the current account", errors=(detail,))
        ...
        try:
            ...
            return CollectorResult(CollectorStatus.FAILED, "network-interface query returned invalid JSON", errors=(str(error),))
        ...
        context.report_progress("network_interfaces_finished", interface_count=len(records), bytes_written=artifact.size_bytes)
