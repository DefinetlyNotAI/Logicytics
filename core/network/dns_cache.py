...
class DnsCacheCollector(CoreCollector):
    ...
    def metadata(cls) -> CollectorMetadata:
        ...
        return CollectorMetadata(
            ...
            description="Exports local DNS resolver cache records through read-only ipconfig output.", author="Logicytics",
            supported_platforms=("win32",), capabilities=(Capability.SUBPROCESS,), sensitive_data_categories=("dns_history",),
    ...
    def collect(self, context: CollectorContext) -> CollectorResult:
        ...
        if completed.returncode != 0:
            ...
            if _is_access_denied(detail):
                return CollectorResult(CollectorStatus.SKIPPED, "DNS-cache access was denied for the current account", errors=(detail,))
