...
class WifiProfileKeysCollector(CoreCollector):
    ...
    def metadata(cls) -> CollectorMetadata:
        ...
        return CollectorMetadata(
            id="core.wireless.wifi_profile_keys",
            name="Saved Wi-Fi profile keys",
            version="4.0.0",
            ...
            sensitive_data_categories=("wireless_profile_names", "credentials"),
    ...
    def collect(self, context: CollectorContext) -> CollectorResult:
        ...
        if completed.returncode != 0:
            ...
            if _is_access_denied(message):
                return CollectorResult(
                    ...
                    "Wi-Fi profile-key access was denied for the current account",
                    errors=(message,),
                )
        ...
        context.report_progress(
            "wifi_profile_keys_finished",
            profile_count=len(artifacts),
