...
def search_google():
    ...
    if not os.path.exists(chrome_login_data_path):
        print(
            "WARNING: Chrome Login Data file not found. Is Chrome installed and the 'Encrypt passwords' feature disabled?")
        return
    ...
    try:
        ...
        if results:
            for result in results:
                print(
                    f"INFO: Found password in Chrome: URL = {result[0]}, Username = {result[1]}, Password = {result[2]}")
        else:
...
def search_opera():
    ...
    if not os.path.exists(opera_login_data_path):
        print(
            "WARNING: Opera Login Data file not found. Is Opera installed and the 'Encrypt passwords' feature disabled?")
        return
    ...
    try:
        ...
        if results:
            for result in results:
                print(
                    f"INFO: Found password in Opera: URL = {result[0]}, Username = {result[1]}, Password = {result[2]}")
        else:
