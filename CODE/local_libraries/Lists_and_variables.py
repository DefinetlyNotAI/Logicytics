...
flags = [
    ...
    ("--mods", "Runs every file in the CODE directory, useful for testing out locally developed scripts."),
    ("--dev",
...
compulsory_flags = ['onlypy', 'setup_only', 'setup', 'minimum', 'only_native', 'debugger_only', 'debugger', 'run',
                    'legacy', 'unzip_extra', 'backup', 'restore', 'update', 'extra', 'mods', 'dev']
...
excluded_files = [
    ...
    'Windows_Defender_Crippler.bat', 'APIGen.py', 'Structure.py',
    'Crash_Reporter.py', 'Error_Gen.py', 'Unzip_Extra.py', 'Crash_Reporter.py', 'Error_Gen.py',
]
